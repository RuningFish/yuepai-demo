<template>
	<scroll-view class="tab-scroll" :style="{'height':tabHeight + 'rpx'}" scroll-x="true">
		<view :style="{'line-height':tabHeight - 10 + 'rpx'}" class="tab-item" v-for="(item,index) in tabList" :key="index" @click="itemIndexChange(index)">
